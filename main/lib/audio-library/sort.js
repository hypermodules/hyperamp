function sort ([keyA, aObj], [keyB, bObj]) {
      ...
      // sort by artist
  if (aObj.artist[0].toLowerCase() < bObj.artist[0].toLowerCase()) return -1
  if (aObj.artist[0].toLowerCase() > bObj.artist[0].toLowerCase()) return 1

      // then by album
  if (aObj.album.toLowerCase() < bObj.album.toLowerCase()) return -1
  if (aObj.album.toLowerCase() > bObj.album.toLowerCase()) return 1
  ...
  if (aObj.track.no > bObj.track.no) return 1
      ...
      // then by title
  if (aObj.title.toLowerCase() < bObj.title.toLowerCase()) return -1
  if (aObj.title.toLowerCase() > bObj.title.toLowerCase()) return 1
